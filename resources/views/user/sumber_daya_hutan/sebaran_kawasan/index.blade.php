    ...
    <div class="widget-box widget-color-dark">
        <div class="widget-header widget-header-small">
            <h6 class="widget-title smaller">
                Sebaran Kawasan Konservasi di Wilayah Provinsi Sumatera Utara
        ...
        <div class="widget-body">
            ...
            {{--widget main list--}}
            @include('user.sumber_daya_hutan.sebaran_kawasan._list')

            {{--widget main insert--}}
            @include('user.sumber_daya_hutan.sebaran_kawasan._insert')
